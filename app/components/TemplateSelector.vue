...
const templates = [
  { id: 'classic', name: '经典留白' },
  { id: 'dark', name: '暗黑风格' },
  { id: 'minimal', name: '极简风格' },
  { id: 'film-style', name: '胶片风格' },
  { id: 'card-style', name: '卡片风格' },
]
...
<template>
  <div class="flex flex-col gap-4">
    <h3 class="text-nord-6 text-sm font-medium">选择模板</h3>
      ...
      >
        ...
        >
          ...
          <div 
            ...
            :style="{ color: getResolvedConfig(tpl.id).fontColor, fontFamily: getResolvedConfig(tpl.id).fontFamily }"
          >
            <span>A</span>
            <span>B</span>
            <span>C</span>
